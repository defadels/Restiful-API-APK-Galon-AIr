	...
	@include('layout.editor.error')
				...
				<div class="page-content">
					...
					<div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
						...
						{{-- <div class="ml-auto">
							<div class="btn-group">
								<a href="{{route('editor.karyawan.create')}}" class="btn btn-primary">+ Karyawan</a> 
							</div>
						</div> --}}
					</div>
					<!--end breadcrumb-->
								...
								<table class="table mb-0">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="{{route('editor.karyawan.edit',$user->id)}}" title="Edit data" class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
											</td>
										</tr>
										@endforeach
									</tbody>
