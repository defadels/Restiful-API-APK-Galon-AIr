								...
								<table class="table mb-0">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="{{route('editor.pesanan.lihat', [$order->id, $order->depot_id])}}" title="Lihat" class="btn btn-sm btn-secondary"><i class="bx bx-show"></i></a>
                                                <a href="{{route('editor.pesanan.masuk', [$order->id, $order->depot_id])}}" title="Edit" class="btn btn-sm btn-success"><i class="bx bx-edit"></i></a>
											</td>
										</tr>
