                    ...
                    <div class="col-12 col-lg-7 border-right">
                        <div class="d-md-flex align-items-center">
                            <div class="mb-md-0 mb-3">
                                <img src="{{$profile->profil??'https://via.placeholder.com/110x110'}}" class="rounded-circle shadow" width="130" height="130" alt="" />
                            </div>
                            <div class="ml-md-4 flex-grow-1">
                                ...
                                <a href="{{route('admin.profile.edit',$profile->id)}}" class="btn btn-primary">Edit Data</a>
                            </div>
                        </div>
                    </div>
